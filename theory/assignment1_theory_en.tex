...
% TODO: vérifier les différentiation de matrices!!
\Answer{
  \begin{align*}
    \pder{L}{W_1} &= \pder{L}{o} \pder{o}{a} \pder{a}{\sigma} \pder{\sigma}{h} \pder{h}{W_{1}}\\
    &= \pder{L}{o} W_{3} (1-\sigma(W_{2}h+b_{2}))x
  \end{align*}
  \begin{align*}
    \pder{L}{W_2} &= \pder{L}{o} \pder{o}{a} \pder{a}{\sigma} \pder{\sigma}{W_{2}}\\
    &= \pder{L}{o} W_{3} (1-\sigma(W_{2}h+b_{2}))h
  \end{align*}
  \begin{align*}
    \pder{L}{W_3} &=
  \end{align*}
