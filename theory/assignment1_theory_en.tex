...
\begin{enumerate}[label=(\alph*)]
 ...
 \item If you apply a filter with a kernel size bigger than 2, and without the feature map size decrease.
 \item It reduces the size of the feature map.
 \item
% TODO: Better formulation
Two layers are sparsely connected if the weight matrix $A$ in the is mostly
composed of zeroes
